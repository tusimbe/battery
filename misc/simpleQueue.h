...
#define Q_TIMEOUT       -1          /**< @brief Timeout condition.          */
#define Q_RESET         -2          /**< @brief Queue has been reset.       */
 ...
 * @iclass
 */
#define chIQIsEmptyI(iqp) ((chQSpaceI(iqp) <= 0))
 ...
 * @iclass
 */
#define chIQIsFullI(iqp)  ((((iqp)->q_wrptr == (iqp)->q_rdptr) &&   \
                                   ((iqp)->q_counter != 0)))
 ...
 * @iclass
 */
#define chOQIsEmptyI(oqp) ((((oqp)->q_wrptr == (oqp)->q_rdptr) &&   \
                                    ((oqp)->q_counter != 0)))
 ...
 * @iclass
 */
#define chOQIsFullI(oqp) ((chQSpaceI(oqp) <= 0))
